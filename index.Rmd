...
- Follow and complete:
    - Friday: 
        - This intro tutorial! 
        - _(Optional)_: if you have not followed the "Python course", it is highly recommended to follow the [Python Refresher](http://www.codecademy.com/tracks/python)
    - Monday morning: [Vector](https://geoscripting-wur.github.io/PythonWeek/VectorPython.html). _This also contains an exercise!_
    ...
    - Tuesday: ArcPy tutorial ?
    - Wednesday morning: [Raster](http://nbviewer.ipython.org/github/GeoScripting-WUR/PythonWeek/blob/gh-pages/Raster%20data%20handling.ipynb). _This also contains an exercise!_
