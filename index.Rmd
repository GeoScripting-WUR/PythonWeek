...
- Follow and complete:
    ...
    - Monday: [Vector](https://geoscripting-wur.github.io/PythonWeek/VectorPython.html). _This also contains an exercise!_
    - Tuesday: _Aldo will provide an excercise via Blackboard!_   
        - check out the following IPython Notebooks created by Aldo Bergsma:
    ...
    - Wednesday: [Raster](http://nbviewer.ipython.org/github/GeoScripting-WUR/PythonWeek/blob/gh-pages/Raster%20data%20handling.ipynb). _This also contains an exercise!_

    - Thursday: Twitter python challenge by Arend Ligtenberg

### Afternoon: Feedback and discussion session at 1330u

* Friday: Johannes
* Monday: Jorge and Johannes
* Tuesday: Aldo & Johannes
* Wednesday: Jan, Johannes, and Jorge
