...
* `conda remove --name astrolab --all` to remove the environment `astrolab`.
...
* `conda install --name my_python matplotlib` to install extra modules in your (running) conda environment
...
conda create -n my_python python=2.7 numpy ipython-notebook # my_python is name of your conda environment
