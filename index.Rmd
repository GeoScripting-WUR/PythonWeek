...
- Follow and complete:
    - Friday: This intro tutorial! _(Optional): if you have not followed the "Python course", it is highly recommended to follow the [Python Refresher](http://www.codecademy.com/tracks/python)_
    - Monday morning: the Python intro below and https://geoscripting-wur.github.io/PythonWeek/VectorPython.html
    - Tuesday morning:
    ...
    - Wednesday morning: [Raster](http://nbviewer.ipython.org/github/GeoScripting-WUR/PythonWeek/blob/gh-pages/Raster%20data%20handling.ipynb)
