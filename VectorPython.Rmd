...
Now create your own shape file containing two locations (e.g. a location of the GAIA building in Wageningen). E.g. go to Google Earth, an extract the coordinates and redo the above excercise (a bonus if you use a `for` loop) and export to KML. 
You can also use the points defined here: https://geoscripting-wur.github.io/IntroToVector/. 

Extra you can create a map with MapNik using the following code (you can download you own location icon from: https://sites.google.com/site/gmapicons/home).
...
```{r, engine='python', eval=FALSE}
# Inthis case we will just render the 2 points from the twoPoints.shp
import os,os.path
import  mapnik
...
## extracting data from the shape file that you just created above
...
#Set boundaries
## double check the below boundaries depending on your extent
## adjust to your own needs
boundsLL = (1.3,49.979, 8.306,52.162) #(minx, miny, maxx,maxy)
