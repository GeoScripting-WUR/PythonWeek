...
Now create your own shape file containing one location (e.g. a location of the GAIA building in Wageningen). Go to Google Earth, extra the coordinates and redo the above excercise and export to KML.


### Modify and reproject a shape file
